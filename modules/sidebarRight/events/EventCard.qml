...
Item {
    ...
    readonly property color colBadge: Appearance.angelEverywhere ? Appearance.angel.colBorderSubtle
        : Appearance.ilmangoEverywhere ? ColorUtils.transparentize(Appearance.ilmango.colBorder, 0.5)
    ...
    Rectangle {
        ...
        color: {
            if (editMA.containsMouse && !root.isExternal) {
                ...
                if (Appearance.ilmangoEverywhere) return Appearance.ilmango.colLayer2Hover
            ...
            if (Appearance.ilmangoEverywhere) return Appearance.ilmango.colLayer2
