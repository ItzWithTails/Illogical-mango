...
Rectangle {
    ...
    // Optional properties
    property real artRadius: Appearance.ilmangoEverywhere ? Appearance.ilmango.roundingSmall : Appearance.rounding.small
    property color placeholderColor: Appearance.ilmangoEverywhere 
        ? Appearance.ilmango.colLayer2 
        : Appearance.colors.colLayer1
    property color iconColor: Appearance.ilmangoEverywhere 
