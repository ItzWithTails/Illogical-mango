...
RippleButton {
    ...
    buttonRadius: Appearance.zzzEverywhere ? Appearance.zzz.controlRadius
               ...
               : Appearance.ilmangoEverywhere ? Appearance.ilmango.roundingSmall : (Appearance?.rounding.full ?? 9999)
    ...
    property color colDisabled: Appearance.zzzEverywhere ? Appearance.zzz.inkMuted
        : Appearance.ilmangoEverywhere ? Appearance.ilmango.colTextDisabled : Appearance.colors.colOutline
