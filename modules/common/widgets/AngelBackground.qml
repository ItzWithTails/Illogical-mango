...
Rectangle {
    ...
    color: angelEverywhere ? "transparent"
        ...
        : ilmangoEverywhere ? ilmangoColor
        : fallbackColor

    clip: true

    layer.enabled: (auroraEverywhere || angelEverywhere) && !ilmangoEverywhere
    ...
    Image {
        ...
        visible: (root.auroraEverywhere || root.angelEverywhere) && !root.ilmangoEverywhere && status === Image.Ready
        source: ((root.auroraEverywhere || root.angelEverywhere) && !root.ilmangoEverywhere) ? root.wallpaperUrl : ""
        ...
        layer.enabled: Appearance.effectsEnabled && (Appearance.auroraEverywhere || Appearance.angelEverywhere) && !Appearance.ilmangoEverywhere
    ...
    Rectangle {
        anchors.fill: parent
        visible: (root.auroraEverywhere || root.angelEverywhere) && !root.ilmangoEverywhere
