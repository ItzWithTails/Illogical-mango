...
Rectangle {
    ...
    color: Appearance.zzzEverywhere ? Appearance.zzz.bg3
        : Appearance.ilmangoEverywhere ? Appearance.ilmango.colBorderMuted : Appearance.colors.colSurfaceContainerHigh
    ...
    Rectangle {
        ...
        color: Appearance.ilmangoEverywhere ? Appearance.ilmango.colLayer2 : Appearance.colors.colSurfaceContainer
