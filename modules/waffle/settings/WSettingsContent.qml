...
Item {
    ...
    property var searchIndex: [
        ...
        { pageIndex: 5, pageName: "Gowall", section: "Color Scheme Source", label: "Illogical-mango theme", targetLabel: "Color Scheme Source", keywords: ["gowall", "ilmango", "palette", "material you"] },
