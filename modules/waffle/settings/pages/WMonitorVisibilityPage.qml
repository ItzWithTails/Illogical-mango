...
WSettingsPage {
    ...
    WSettingsCard {
        ...
        InfoBanner {
            iconName: "info"
            message: Translation.tr("This page controls where Illogical-mango shell surfaces appear. It does not change monitor resolution, scale, rotation, or physical output layout.")
        }
