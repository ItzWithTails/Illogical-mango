            ...
            Row {
                ...
                BigRecorderButton {
                    ...
                    onClicked: {
                        ...
                        Quickshell.execDetached([Quickshell.shellPath("scripts/ilmango"), "region", "screenshot"]);
                    }
                }
                ...
                BigRecorderButton {
                    ...
                    onClicked: {
                        GlobalStates.overlayOpen = false;
                        Quickshell.execDetached([Quickshell.shellPath("scripts/ilmango"), "region", "recordWithSound"]);
                    }
                }
