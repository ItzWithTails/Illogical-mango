...
Item {
    ...
    Item {
        ...
        Loader {
            active: Appearance.angelEverywhere || (!Appearance.ilmangoEverywhere && !Appearance.auroraEverywhere)
        ...
        GlassBackground {
            ...
            border.width: (Appearance.angelEverywhere || Appearance.ilmangoEverywhere || Appearance.auroraEverywhere) ? 1 : 0
