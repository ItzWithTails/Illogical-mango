# Generic dependency installation guide for Illogical-mango
...
echo -e "${STY_CYAN}║           Illogical-mango - Generic Installation Guide                      ║${STY_RST}"
echo -e "${STY_CYAN}╚══════════════════════════════════════════════════════════════════╝${STY_RST}"
echo ""
...
echo "  - https://github.com/ItzWithTails/illogical-mango/wiki/Manual-Installation"
