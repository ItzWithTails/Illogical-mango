# Robust update system for Illogical-mango
...
II_MANIFEST_FILE="${II_TARGET}/.ilmango-manifest"
...
create_update_backup() {
    ...
    rsync -a --exclude='.ilmango-manifest' "$target_dir/" "$backup_path/" 2>/dev/null
