# Dependency installation router for Illogical-mango
...
case "$OS_GROUP_ID" in
  ...
  nixos)
    ...
    echo ""
    echo "For NixOS, add Illogical-mango to your configuration.nix or home-manager."
    echo "See: https://github.com/ItzWithTails/illogical-mango/wiki/NixOS"
    echo ""
    echo "Basic steps:"
    echo "  1. Add quickshell and niri to your system packages"
    echo "  2. Clone this repo to ~/.config/quickshell/ilmango"
