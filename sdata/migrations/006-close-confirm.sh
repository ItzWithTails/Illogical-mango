...
MIGRATION_DESCRIPTION="Replaces Mod+Q close-window with Illogical-mango's closeConfirm script.
...
migration_preview() {
  ...
  echo -e "${STY_GREEN}+ Mod+Q { spawn \"ilmango\" \"close-window\"; }${STY_RST}"
}
...
replacement = 'Mod+Q repeat=false { spawn "ilmango" "close-window"; }'
