...
migration_preview() {
  echo -e "${STY_GREEN}+ XF86AudioPlay { spawn \"ilmango\" \"mpris\" \"playPause\"; }${STY_RST}"
  echo -e "${STY_GREEN}+ XF86AudioPause { spawn \"ilmango\" \"mpris\" \"playPause\"; }${STY_RST}"
  echo -e "${STY_GREEN}+ XF86AudioNext { spawn \"ilmango\" \"mpris\" \"next\"; }${STY_RST}"
  echo -e "${STY_GREEN}+ XF86AudioPrev { spawn \"ilmango\" \"mpris\" \"previous\"; }${STY_RST}"
}
...
if insert_idx is not None:
    ...
    XF86AudioPlay { spawn "ilmango" "mpris" "playPause"; }
    XF86AudioPause { spawn "ilmango" "mpris" "playPause"; }
    XF86AudioNext { spawn "ilmango" "mpris" "next"; }
    XF86AudioPrev { spawn "ilmango" "mpris" "previous"; }
'''
