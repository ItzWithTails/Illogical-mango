...
MIGRATION_DESCRIPTION="Adds XF86MonBrightnessUp/Down keybinds that use Illogical-mango IPC.
...
migration_preview() {
  echo -e "${STY_GREEN}+ XF86MonBrightnessUp { spawn \"ilmango\" \"brightness\" \"increment\"; }${STY_RST}"
  echo -e "${STY_GREEN}+ XF86MonBrightnessDown { spawn \"ilmango\" \"brightness\" \"decrement\"; }${STY_RST}"
}
...
if insert_idx is not None:
    ...
    XF86MonBrightnessUp { spawn "ilmango" "brightness" "increment"; }
    XF86MonBrightnessDown { spawn "ilmango" "brightness" "decrement"; }
'''
