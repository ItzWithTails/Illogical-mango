#!/usr/bin/env python3
"""
YouTube Music OAuth Setup for Illogical-mango
...
def banner():
    print(f"""
{CYAN}{B}╔══════════════════════════════════════════════════════╗
║         Illogical-mango — YouTube Music OAuth Setup             ║
╚══════════════════════════════════════════════════════╝{R}
""")
...
def main():
    ...
    print(f"""{B}This wizard will set up OAuth so Illogical-mango can like/unlike songs
...
""")
  ...
  2. Name it anything (e.g. "ilmango-ytmusic")
  3. Click {B}Create{R}
...
""")
  ...
  3. App name: anything (e.g. "Illogical-mango")
...
""")
  ...
  4. Name: anything (e.g. "ilmango-cli")
  5. Click {B}Create{R}
