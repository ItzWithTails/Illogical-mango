...
ZED_THEMEGEN_BIN="$STATE_DIR/user/generated/bin/ilmango-zed-themegen"
ZED_THEMEGEN_SRC="$SCRIPT_DIR/zed_themegen/main.go"
ZED_OUTPUT_FILE="$HOME/.config/zed/themes/ii-theme.json"
ZED_TEMPLATE_FILE="$REPO_ROOT/defaults/matugen/templates/zed-colors.json"
...
ensure_zed_themegen() {
  ...
  local tmp_bin="$STATE_DIR/user/generated/bin/.ilmango-zed-themegen.$$"
