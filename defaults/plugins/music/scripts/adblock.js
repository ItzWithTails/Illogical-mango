// YouTube Music AdBlock userscript for Illogical-mango WebEngine
...
(function() {
    ...
    const LOG_PREFIX = '[Illogical-mango-AdBlock]';
    ...
    function muteAdAudio() {
        ...
        if (player.classList.contains('ad-showing')) {
            if (!video.muted) {
                video.muted = true;
                video.dataset.ilmangoMuted = 'true';
            }
        } else if (video.dataset.ilmangoMuted === 'true') {
            video.muted = false;
            delete video.dataset.ilmangoMuted;
        }
    }
