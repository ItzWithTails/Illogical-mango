// SponsorBlock userscript for Illogical-mango WebEngine
...
(function() {
    ...
    const LOG_PREFIX = '[Illogical-mango-SponsorBlock]';
    ...
    function showSkipNotification(category) {
        ...
        const existing = document.getElementById('ilmango-sb-notification');
        ...
        div.id = 'ilmango-sb-notification';
        div.style.cssText = `
            position: fixed;
            bottom: 100px;
            right: 20px;
