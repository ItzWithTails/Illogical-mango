...
2. Use [GitHub's private vulnerability reporting](https://github.com/ItzWithTails/illogical-mango/security/advisories/new).
...
Illogical-mango is a desktop shell that runs with user-level permissions. Security concerns include:
...
Out of scope: compositor vulnerabilities (Niri/Hyprland), Qt/Quickshell framework bugs, and system-level privilege escalation (Illogical-mango never runs as root).
