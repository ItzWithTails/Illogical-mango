...
- Most config changes apply immediately. Some (like enabling/disabling modules) require restarting Illogical-mango with `ilmango restart`.
...
1. Check `ilmango logs` for errors - the answer is usually right there
