...
GroupButton {
    ...
    buttonRadius: down ? (Appearance.ilmangoEverywhere ? Appearance.ilmango.roundingSmall : Appearance.rounding.verysmall) : (Appearance.ilmangoEverywhere ? Appearance.ilmango.roundingNormal : Appearance.rounding.small)
