...
RippleButton {
    ...
    buttonRadius: Appearance.zzzEverywhere
        ...
        : (Appearance.angelEverywhere ? Appearance.angel.roundingLarge
            : Appearance.ilmangoEverywhere ? Appearance.ilmango.roundingLarge : Appearance.rounding.verylarge)
    colBackground: Appearance.zzzEverywhere
        ? (button.keyboardDown
            ? Appearance.zzz.signal
            : button.focus ? Appearance.zzz.sticker : Appearance.zzz.paperAlt)
        : button.keyboardDown
        ? (Appearance.ilmangoEverywhere ? Appearance.ilmango.colPrimaryActive : Appearance.colors.colSecondaryContainerActive)
        : button.focus
    ...
    colBackgroundHover: Appearance.zzzEverywhere ? ColorUtils.applyAlpha(Appearance.zzz.sticker, 0.88)
        : Appearance.ilmangoEverywhere ? Appearance.ilmango.colPrimaryHover : Appearance.colors.colPrimary
    colRipple: Appearance.zzzEverywhere ? ColorUtils.applyAlpha(Appearance.zzz.accent, 0.30)
        : Appearance.ilmangoEverywhere ? Appearance.ilmango.colPrimaryActive : Appearance.colors.colPrimaryActive
