...
Item {
    ...
    Rectangle {
        ...
        Image {
            ...
            asynchronous: true
            cache: false
            opacity: Appearance.ilmangoEverywhere ? 0.2 : (Appearance.auroraEverywhere ? 0.3 : 0.6)
            visible: root.displayedArtFilePath !== ""

            layer.enabled: Appearance.effectsEnabled
            layer.effect: MultiEffect {
                blurEnabled: true
                blur: Appearance.ilmangoEverywhere ? 0.5 : 0.4
                blurMax: 32
                saturation: Appearance.ilmangoEverywhere ? 0.1 : 0.4
            }
        }
        ...
        RowLayout {
            ...
            Rectangle {
                ...
                Rectangle {
                    anchors.fill: parent
                    color: Appearance.ilmangoEverywhere ? root.jiraColLayer2 : (blendedColors?.colLayer1 ?? Appearance.colors.colLayer1)
                    ...
                    MaterialSymbol {
                        ...
                        text: "music_note"
                        iconSize: 32
                        color: Appearance.ilmangoEverywhere ? root.jiraColTextSecondary : (blendedColors?.colSubtext ?? Appearance.colors.colSubtext)
                    }
                }
            }
            ...
            ColumnLayout {
                ...
                StyledText {
                    ...
                    color: Appearance.ilmangoEverywhere ? root.jiraColText : (blendedColors?.colOnLayer0 ?? Appearance.colors.colOnLayer0)
                ...
                Item {
                    ...
                    Loader {
                        ...
                        sourceComponent: StyledSlider {
                            ...
                            highlightColor: Appearance.ilmangoEverywhere ? root.jiraColPrimary : (blendedColors?.colPrimary ?? Appearance.colors.colPrimary)
                            trackColor: Appearance.ilmangoEverywhere ? Appearance.ilmango.colLayer2 : Appearance.zzzEverywhere ? Appearance.colors.colLayer2 : (blendedColors?.colSecondaryContainer ?? Appearance.colors.colSecondaryContainer)
                            handleColor: Appearance.ilmangoEverywhere ? root.jiraColPrimary : (blendedColors?.colPrimary ?? Appearance.colors.colPrimary)
                ...
                RowLayout {
                    ...
                    RippleButton {
                        ...
                        colBackgroundHover: Appearance.ilmangoEverywhere ? Appearance.ilmango.colLayer2Hover : ColorUtils.transparentize(blendedColors?.colLayer1 ?? Appearance.colors.colLayer1, 0.5)
                        colRipple: Appearance.ilmangoEverywhere ? Appearance.ilmango.colLayer2Active : (blendedColors?.colLayer1Active ?? Appearance.colors.colLayer1Active)
                    ...
                    RippleButton {
                        ...
                        colBackgroundHover: Appearance.ilmangoEverywhere
                        ...
                        colRipple: Appearance.ilmangoEverywhere
