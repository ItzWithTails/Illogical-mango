#!/usr/bin/env python3
"""Add a plugin to the Illogical-mango plugin directory.
...
def resolve_shell_config_dir() -> str:
    ...
    new_dir = os.path.join(xdg_config, "ilmango")
...
def main():
    parser = argparse.ArgumentParser(
        description="Add a web plugin to the Illogical-mango plugin directory."
    )
