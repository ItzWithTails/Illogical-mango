...
def resolve_default_config_path() -> Path:
    ...
    new_file = xdg_config_home / "ilmango" / "config.json"
...
def scaffold_target(args, colors_dir: Path, targets_dir: Path) -> int:
    ...
    description = args.description or f"Apply generated Illogical-mango palette to {label}."
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Illogical-mango theming target tools")
    parser.add_argument(
        "command",
        nargs="?",
        default="list",
