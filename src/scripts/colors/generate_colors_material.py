#!/usr/bin/env -S\_/bin/sh\_-c\_"source\_\$(eval\_echo\_\${ILMANGO_VENV:-\$ILLOGICAL_IMPULSE_VIRTUAL_ENV})/bin/activate&&exec\_python\_-E\_"\$0"\_"\$@""
import argparse
import math
import json
import os
...
# ---------------------------------------------------------------------------
# Template rendering for Illogical-mango's unified theming pipeline
# ---------------------------------------------------------------------------
