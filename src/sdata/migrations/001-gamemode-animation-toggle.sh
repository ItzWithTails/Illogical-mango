...
# This allows Illogical-mango to toggle animations on/off for gaming

MIGRATION_ID="001-gamemode-animation-toggle"
MIGRATION_TITLE="GameMode Animation Toggle"
MIGRATION_DESCRIPTION="Adds //off comment to Niri animations block, allowing Illogical-mango
